...
The Executive Summary (line 33) states: *"The system's central data structure is a flat allocation table -- one row per person/project/month -- from which all views derive."*
...
**Checklist verification:** Line 3957: *"All tables have organization_id for tenant isolation"*. YES.
