    ...
    return (
      <div className="rounded-lg border border-outline-variant/30 bg-surface-container-low p-8 text-center">
        <p className="text-on-surface-variant">
          No capacity alerts for this period.
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      {overloaded.length > 0 && (
        <section>
          ...
          <div className="divide-y divide-outline-variant/30 rounded-lg border border-outline-variant/30 bg-surface-container-low">
  ...
  return (
    <div className="flex items-center justify-between gap-4 px-4 py-3">
      <div className="min-w-0 flex-1">
        ...
        <p className="text-xs text-on-surface-variant">{alert.departmentName}</p>
      </div>
